...
# URL target 
base_url = 'https://www.rumah123.com/jual/jakarta-barat/rumah/?certificates%5B%5D=6&certificates%5B%5D=5&certificates%5B%5D=3&certificates%5B%5D=4&certificates%5B%5D=7&certificates%5B%5D=8&certificates%5B%5D=9&certificates%5B%5D=10&maxPrice=50000000000&minPrice=500000000&transactedIncluded=1'
...
NAMA_FILE_OUTPUT = 'scraping_data/scraping_data_result/data_jakbar_Lainnya_final.csv'
# ==============================================================================

semua_data_properti = []
halaman = 1

print(f"=== STRATIFIED SAMPLING: Lainnya JAKARTA BARAT ===")
...
while len(semua_data_properti) < TARGET_SAMPEL:
    ...
    try:
        ...
        if halaman % 100 == 0:
            ...
            df_temp.to_csv(f'backup_Lainnya_jakbar_{len(semua_data_properti)}_baris.csv', index=False)
