...
POPULASI_JAKUT_TERBARU = 101641  

# Formula Target: Mengambil 10% dari 10% dari populasi Lainnya tersebut
TARGET_SAMPEL = int(POPULASI_JAKUT_TERBARU * 0.10 * 0.10)  

# URL target 
base_url = 'https://www.rumah123.com/jual/jakarta-utara/rumah/?certificates%5B%5D=6&certificates%5B%5D=5&certificates%5B%5D=3&certificates%5B%5D=4&certificates%5B%5D=7&certificates%5B%5D=8&certificates%5B%5D=9&certificates%5B%5D=10&maxPrice=50000000000&minPrice=500000000&transactedIncluded=1'
...
NAMA_FILE_OUTPUT = 'data_jakut_Lainnya_final.csv'
# ==============================================================================

semua_data_properti = []
halaman = 1

print(f"=== STRATIFIED SAMPLING: Lainnya JAKARTA UTARA ===")
print(f"Populasi Acuan : {POPULASI_JAKUT_TERBARU}")
