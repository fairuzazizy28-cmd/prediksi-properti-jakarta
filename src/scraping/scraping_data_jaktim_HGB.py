...
# URL target 
base_url = 'https://www.rumah123.com/jual/jakarta-timur/rumah/?certificates%5B%5D=2&maxPrice=50000000000&minPrice=500000000&transactedIncluded=1'
...
NAMA_FILE_OUTPUT = 'data_jaktim_HGB_final.csv'
# ==============================================================================

semua_data_properti = []
halaman = 1

print(f"=== STRATIFIED SAMPLING: HGB JAKARTA TIMUR ===")
...
while len(semua_data_properti) < TARGET_SAMPEL:
    ...
    try:
        ...
        if halaman % 100 == 0:
            ...
            df_temp.to_csv(f'backup_HGB_jakpus_{len(semua_data_properti)}_baris.csv', index=False)
