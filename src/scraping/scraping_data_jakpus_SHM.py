...
TARGET_SAMPEL = int(POPULASI_JAKPUS_TERBARU * 0.10 * 0.8)  

# URL target 
base_url = 'https://www.rumah123.com/jual/jakarta-pusat/rumah/?certificates%5B%5D=1&maxPrice=50000000000&minPrice=500000000&transactedIncluded=1'
...
NAMA_FILE_OUTPUT = 'data_jakpus_SHM_final.csv'
# ==============================================================================

semua_data_properti = []
halaman = 1

print(f"=== STRATIFIED SAMPLING: SHM JAKARTA PUSAT ===")
